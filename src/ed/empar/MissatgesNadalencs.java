...
public class MissatgesNadalencs {
	////
	...
	// NO modifiques este métode
	private static void missatgeProfessor() {
		System.out.println("====================================");
		System.out.println("Hola, sóc EMPAR la professora de ED");
	...
	// ***************************************************
	// PROGRAMA el mètode que et correspon a partir d'ací
	// Deixa una línia en blanc després d'imprimir
	// ***************************************************
	...
	// FILA 5
	private static void AlumneFila5PC1() {
	...
	private static void AlumneFila5PC4() {

	}

	private static void AlumneFila5PC5() {

	}

	private static void AlumneFila5PC6() {
