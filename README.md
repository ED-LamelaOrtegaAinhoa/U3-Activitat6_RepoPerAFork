...
* Fes un *pull-request* per a demanar al propietari del repositori (que és el professor) que revise la teua feina i que incorpore a la rama master els canvis de la teua rama.
...
#### PROFESSOR:   EMPAR
Empar ha afegit el mètode que desitja: "Bon Nadal i Feliç Any Nou.  Pau i Salut per a tots."
